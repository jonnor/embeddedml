...
- Sensor levels intro slide
- Smart Camera. Missing CNN. From MNIST. Fun example, detect (your) cat

- Test audio+video in Discord
- Full rehearsal
...
- T-watch image for HAR. 
NN minutes for each of the categories/classes
