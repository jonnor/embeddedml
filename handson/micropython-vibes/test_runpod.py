...
endpoints = {
    ...
    'runpod-custom/gpt-oss-20b': ('openai/gpt-oss-20b', "https://api.runpod.ai/v2/rssll5qi6dwhhj/openai/v1"), # XXX: ensure ENDPOINT_ID is correct
}

model = 'runpod/qwen3-32b'
model = 'runpod-custom/gpt-oss-20b'
