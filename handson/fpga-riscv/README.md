...
- `--cpu-type picorv32 --cpu-variant minimal`. Blink works. 3400 LUTs. No JTAG pins.
- `--cpu-type femtorv --cpu-variant standard`. Blink and UART out works. 2500 LUTs. **No interrupts**.
- `--cpu-type fazyrv --cpu-variant standard`. Blink works. 2300 LUTs. **No interrupts**. No JTAG.
